...
|---|---|---|
| **Setup** | `docker run riklr/key2a:latest` | `bun add @riklr/key2a` |
...
Run Key2a as a pre-built Docker container. No code required — configure entirely via environment variables and point it at your own token-issuance endpoint.
