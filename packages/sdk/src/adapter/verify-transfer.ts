...
export async function verifyTransfer(params: VerifyTransferParams): Promise<VerificationResult> {
	const { txHash, expectedTo, expectedAmountRaw, challengeExpiresAt, networkConfig, client } =
		params;
