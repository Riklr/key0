/**
 * Client agent demonstrating the full Key2a payment flow on Base Sepolia testnet:
 *
...
import type { AccessGrant, AgentCard, NetworkName, X402Challenge } from "@riklr/key2a";
import { CHAIN_CONFIGS, parseDollarToUsdcMicro, USDC_ABI } from "@riklr/key2a";
...
async function main() {
	console.log("=== Key2a Client Agent ===\n");
