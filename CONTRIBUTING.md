...
- **GitHub Discussions:** [github.com/Riklr/key2a/discussions](https://github.com/Riklr/key2a/discussions)
...
If you are adding a new framework integration, follow the existing pattern in `src/integrations/` — wrap the core `Key2a` instance, don't reimplement logic.
