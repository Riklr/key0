...
description: The 5 security invariants that protect Key2a's payment flow. Load this to know what must never be broken — and therefore what must always be tested and reviewed.
---

# Key2a Payment Security Invariants
